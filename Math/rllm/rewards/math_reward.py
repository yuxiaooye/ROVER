...
class RewardMathFn(RewardFn):
    ...
    def __call__(self, input: RewardInput) -> RewardOutput:
        ...
        # print('>>> extracted model_answer: ', model_answer)
        ...
        for ground_truth in processed_ground_truths:
            # print('>>> model_answer: ', model_answer, 'ground_truth: ', ground_truth)
...
if __name__ == "__main__":
    ...
    output = reward(test_input)  # RewardOutput(reward=1.5, is_correct=True)
    print(output)
