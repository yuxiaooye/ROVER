...
from verl.trainer.main_rover import RewardManager
...
def main(config):
    ...
    reward_model_data = dataset['reward_model']#['ground_truth']
    ...
    for i in range(total):
        ...
        for r in response_lst:
            ...
            score = reward_fn(solution_str=r, ground_truth=ground_truth)
    ...
    total_scores = [[1.0 if val==1.0 else 0.0 for val in score_list] for score_list in total_scores]
